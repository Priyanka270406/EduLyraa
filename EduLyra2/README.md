...
- Industry opportunity publishing and candidate/application workspace, with Post Opportunities grouped into internships, workshops and trainings.
...
## Innovation Additions — EduLyra M1

This update preserves the existing student, faculty, industry and institution workflows and adds:

- **Industry Opportunity Studio:** one publishing workspace for internships, workshops and collaborative opportunities.
- **Experience-first industry posting:** workshops and trainings use learner registration, while internships retain applications.
- **Opportunity DNA:** learner-facing explanation of existing skills, skill gaps and the recommended next action for every opportunity card.
- **Opportunity metadata:** capacity, target audience, engagement mode and publish time are retained with each listing.
- **Industry dashboard quick publishing:** direct access to the Opportunity Studio without replacing the existing recruitment pipeline.
